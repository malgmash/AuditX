...
Three people work in parallel, one stream each. Match what the user says to a stream file:
...
1. Read WORKSTREAMS.md and the stream file in full.
...
- Code against the fixtures and interfaces in WORKSTREAMS.md so you never block on another stream.
